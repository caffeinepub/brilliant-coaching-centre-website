...
export default function Teachers() {
  ...
  const teachers = [
    {
      ...
      focus: [
        t(
          "Expert in early childhood and primary education",
          "প্রাথমিক শৈশব এবং প্রাথমিক শিক্ষায় বিশেষজ্ঞ",
        ),
        t(
          "Focus on strong foundations and confidence building",
          "শক্তিশালী ভিত্তি এবং আত্মবিশ্বাস তৈরিতে মনোনিবেশ",
        ),
      ],
    },
    {
      ...
      initials: "AD",
      avatar:
        "/assets/uploads/Screenshot_2025-11-29-07-21-35-35_965bbf4d18d205f782c6b8409c5773a4-1.jpg",
      classes: t("Class 4 – Class 10", "ক্লাস ৪ – ক্লাস ১০"),
      subjects: t("Mathematics", "গণিত"),
      experience: t("5 Years", "৫ বছর"),
      focus: [
        t(
          "Clear explanations and problem-solving techniques",
          "স্পষ্ট ব্যাখ্যা এবং সমস্যা সমাধানের কৌশল",
        ),
        t(
          "Focus on accuracy and exam performance",
          "নির্ভুলতা এবং পরীক্ষার পারফরম্যান্সে মনোনিবেশ",
        ),
      ],
    },
    {
      ...
      focus: [
        t(
          "Expert in grammar, writing, and communication skills",
          "ব্যাকরণ, লেখা এবং যোগাযোগ দক্ষতায় বিশেষজ্ঞ",
        ),
        t(
          "Strong exam-oriented teaching approach",
          "শক্তিশালী পরীক্ষা-ভিত্তিক শিক্ষাদান পদ্ধতি",
        ),
      ],
    },
  ];
  ...
  return (
    <section
      id="teachers"
      className="py-20 md:py-32 bg-gradient-to-b from-background to-accent/5"
    >
