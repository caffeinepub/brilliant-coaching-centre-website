...
export default function AdmissionForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!studentClass) {
      toast.error(
        t("Please select a class.", "অনুগ্রহ করে একটি ক্লাস নির্বাচন করুন।"),
      );
      return;
    }
    if (!mobile.trim() || mobile.trim().length < 10) {
      toast.error(
        t(
          ...
          "অনুগ্রহ করে একটি বৈধ মোবাইল নম্বর লিখুন।",
        ),
      );
      return;
    }
  ...
  return (
    <section
      id="admission"
      className="py-20 md:py-32 bg-gradient-to-b from-accent/5 to-background"
    >
            ...
            <div className="space-y-2">
              ...
              <Select value={studentClass} onValueChange={setStudentClass}>
                <SelectTrigger className="bg-background border-border">
                  <SelectValue
                    placeholder={t("Select class", "ক্লাস নির্বাচন করুন")}
                  />
                </SelectTrigger>
                <SelectContent>
                  {classes.map((cls) => (
