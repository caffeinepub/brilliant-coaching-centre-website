...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: t("Phone", "ফোন"),
      content: "9735857573 | 8436529117",
      action: () => window.open("tel:+919735857573"),
    },
    {
      icon: MessageCircle,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 max-w-5xl mx-auto">
          <div className="bg-card border-2 border-gold/20 rounded-2xl overflow-hidden shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3691.2!2d87.0756!3d23.2273!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f410a1b5f5f5f5%3A0x8e5e5e5e5e5e5e5e!2sPuabagan%2C%20Bankura%2C%20West%20Bengal%20722101!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title={t(
                "Brilliant Coaching Centre Location",
                "ব্রিলিয়ান্ট কোচিং সেন্টার অবস্থান",
              )}
